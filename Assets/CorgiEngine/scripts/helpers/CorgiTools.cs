...
namespace MoreMountains.CorgiEngine
{
	...
	public static class CorgiTools 
	{
		...
		public static RaycastHit2D CorgiRayCast(Vector2 rayOriginPoint, Vector2 rayDirection, float rayDistance, LayerMask mask,bool debug,Color color,bool drawGizmo=false)
		{	
			if (drawGizmo) 
			{
